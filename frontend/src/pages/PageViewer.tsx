    ...
    const getRenderedContent = () => {
      ...
      console.log('Raw content:', content);
          ...
          renderer.link = (props) => {
            ...
            // Immediately delegate if href is missing, as it's an edge case we don't want to handle.
            ...
            try {
              ...
              if (href.startsWith('/pages/')) {
              ...
              } else if (!href.startsWith('http') && !href.startsWith('/') && !href.includes(':')) {
                ...
                const foundPage = allPages.find(p => p.startsWith(pageName + '.'));
                ...
                pageFileName = foundPage ? foundPage : pageName + '.md';
            ...
            // Fallback for all other link types (external, etc.)
